...
export default async function ComandaPage () {
  return (
    <main className='pt-36 pb-10 px-9 relative w-full font-inter-sans bg-grid-small-black dark:bg-grid-small-white flex flex-col items-center overflow-y-auto'>
